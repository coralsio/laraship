...
@section('content')
    ...
    <div class="register-box-body">
        <p>{{trans('corals-admin::labels.auth.token_has_been_sent',['name' => $user->phone])}}</p>
        ...
        <form method="POST" action="{{url('auth/token')}}">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <button type="submit" class="btn btn-success btn-block">@lang('corals-admin::labels.auth.verify_token')</button>
                    <br/>
