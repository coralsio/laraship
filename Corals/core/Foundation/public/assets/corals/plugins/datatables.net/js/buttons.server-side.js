(function ($, DataTable) {
    ...
    var _openInNewTab = function openInNewTab(url) {
    ...
    var _buildUrl = function(dt, action) {
        ...
        let currentURLParameters = window.location.href.split('?').pop();

        if (url.indexOf('?') > -1) {
            return url + '&' + $.param(params) + '&' + currentURLParameters;
        }
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: function (dt) {
            return '<i class="fa fa-file-excel-o"></i> ' + dt.i18n('buttons.excel', 'Download Data');
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: function (dt) {
            return '<i class="fa fa-file-excel-o"></i> ' + dt.i18n('buttons.csv', 'Mail Data');
        },
